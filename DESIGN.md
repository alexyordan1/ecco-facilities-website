...
**Caveat rule:** transitional helpers and Alina-attributed lines only. `.qf2-not-sure-link`, `.qf2-quiz-result-hand`, `.qf2-field-helper`, `.qf2-section-label`, `.qf2-multi-loc-hint`. Never on primary actions. Never on errors.
