...
(function initPillars() {
  ...
  var data = [
    { badge: '$', title: 'Transparent, custom pricing', text: 'Every proposal is built from scratch for your space. No generic packages, no hidden fees. You only pay for what you need. Most clients are surprised at how competitive our pricing is, and you\u2019ll have transparent numbers within 24 hours.' },
    { badge: '\u2713', title: 'Re-clean guarantee', text: 'If anything isn\u2019t right, tell us within 24 hours and we\u2019ll re-clean the affected areas at no charge.' },
    ...
    { badge: '\uD83C\uDF3F', title: 'Eco-certified products', text: 'We use Green Seal and EPA Safer Choice certified products. Biodegradable, plant-based, and safe for children, pets, and people with allergies, with no harsh chemicals.' },
    { badge: '\u221E', title: 'Flexible terms, no lock-ins', text: 'We don\u2019t lock you into rigid multi-year contracts. If something isn\u2019t working, you can adjust or cancel. We aim to keep your business by earning it, not by locking you in.' },
    { badge: '\uD83D\uDC65', title: 'A consistent, dedicated team', text: 'Consistency is core. Your team learns your space, preferences, and standards. If someone\u2019s unavailable, we notify you and send a trained backup.' }
  ];
