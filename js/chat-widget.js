...
.ecco-chat-trust-strip { display: flex; gap: .35rem; align-items: center; font-size: .62rem; color: rgba(11,29,56,.5); font-weight: 500; margin-top: .25rem; font-family: 'DM Sans', system-ui, sans-serif; letter-spacing: .01em; flex-wrap: wrap; }
.ecco-chat-trust-strip .sep { opacity: .5; }
.ecco-chat-trust-strip strong { color: rgba(11,29,56,.7); font-weight: 600; }
...
@media (max-width: 480px) {
  ...
  .ecco-chat-trust-strip { display: none; }
